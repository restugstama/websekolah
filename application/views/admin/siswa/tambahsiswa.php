            ...
            <form action="<?= base_url().'admin/siswa/tambahsiswa' ?>" method="post">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="<?= set_value('tanggal_lahir'); ?>">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="jenis_kelamin" id="jenis_kelamin" class="form-control" value="<?= set_value('jenis_kelamin'); ?>">
